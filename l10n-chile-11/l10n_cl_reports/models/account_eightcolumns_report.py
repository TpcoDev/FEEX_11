...
class AccountAccount(models.Model):
    ...
    internal_group = fields.Char(compute='_calc_internal_group', store=True, string='Internal Group')

    @api.depends('code')
    def _calc_internal_group(self):
        internal_group = {
            '1': 'asset',
            '2': 'liability',
            '3': 'income',
        ...
        for record in self:
            record.internal_group = internal_group[record.code[0]]

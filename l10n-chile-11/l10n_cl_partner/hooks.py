...
# campos renombrados en l10n_cl_invoice
column_renames = {
    'res_partner': [
...
def fix_data_on_l10n_cl_partner(cr):
    _logger.info('Fixing data on l10nar partner')
    # pasamos de a account_account a l10n_cl_partner
    old_name = 'account_document'
    new_name = 'l10n_cl_partner'

    l10n_cl_partner_data_models = [
        # 'res.partner', al final este es de l10n_cl_account y lo arregla
        # account_document
    ...
    update_data_module_name(
        cr, l10n_cl_partner_data_models, old_name, new_name)

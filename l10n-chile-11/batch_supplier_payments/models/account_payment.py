...
class AccountPayment(models.Model):
    ...
    batch_id = fields.Many2one(
        'account.batch.payments', 'Batch', help="Only if this payment was created from a Batch process")
    ...
    def _create_payment_entry(self, amount):
        ...
        if not self.batch_id:
            ...
            move = move_obj.search([('batch_id', '=', self.batch_id.id)])
            if not move:
                move = move_obj.create(self._get_move_vals())
                move.batch_id = self.batch_id.id
            ...
            if self.payment_difference_handling == 'reconcile' and self.payment_difference:
                ...
                # See revision 20935462a0cabeb45480ce70114ff2f4e91eaf79 for a detailed example.
            ...
            if aml2: 
                aml2.name += liquidity_aml_dict['name']
                aml2.debit += liquidity_aml_dict['debit']
                aml2.credit += liquidity_aml_dict['credit']
                aml2.partner_id = False
            else:

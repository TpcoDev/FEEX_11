...
class AccountArVatLine(models.Model):
    ...
    _description = "Línea de IVA para análisis en localización chile"
    _auto = False
    ...
    def init(self):
        ...
        vat_tax_groups = env['account.tax.group'].search(
            [('tax', '=', 'vat')])
        tg_nc = ref('l10n_cl_account.tax_group_iva_no_corresponde', False)
        tg_ng = ref('l10n_cl_account.tax_group_iva_no_gravado', False)
        tg_ex = ref('l10n_cl_account.tax_group_iva_exento', False)
        tg_0 = ref('l10n_cl_account.tax_group_iva_0', False)
        tg_21 = ref('l10n_cl_account.tax_group_iva_21', False)
        tg_10 = ref('l10n_cl_account.tax_group_iva_10', False)
        tg_27 = ref('l10n_cl_account.tax_group_iva_27', False)
        tg_25 = ref('l10n_cl_account.tax_group_iva_25', False)
        tg_5 = ref('l10n_cl_account.tax_group_iva_5', False)
        tg_iva0 = False
        if tg_nc and tg_ng and tg_ex and tg_0:
            tg_iva0 = tg_nc + tg_ng + tg_ex + tg_0
        tg_per_iva = ref('l10n_cl_account.tax_group_percepcion_iva', False)
